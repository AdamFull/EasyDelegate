...
namespace manual_using
{
    ...
    {
        TDelegate<int(int, int, bool)> fooDelegate;          //Creating delegate object with specified signature
        ...
        TDelegate<int(int, bool)> fooLambdaDelegate;         //Also you can attach lambda
